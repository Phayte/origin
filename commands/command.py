...
class ExitCommand(Command):
    ...
    def func(self):
        ...
        self.caller.last_exit = self.obj
    ...
    def get_extra_info(self, caller, **kwargs):
        ...
        Args:
            caller (Object): The object (usually a character) that entered
            an ambiguous command.

        Returns:
            A string with identifying information to disambiguate the command,
